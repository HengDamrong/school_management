                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="{{$user->name}}" name="name" class="form-control" required="username">
                                                </div>
                                            </div>
                                        </div><!-- End Col Md-6 -->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input value="{{$user->mobile}}" type="text" name="mobile" class="form-control" required="">
                                                </div>
                                            </div>
                                        </div> <!-- End Col Md-6 -->
                                        <div class="col-md-6">
